...
The maximum number of steps averaged across days (rounded `max_average`) is **206 steps**, it happens at **08h35** (`interval_max_steps_ftime`)
...
- Mean total number of steps taken each day : **10 766 steps **

- Median total number of steps taken each day : **10 762 steps**
